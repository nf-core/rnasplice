...
class RowChecker:
    ...
    def __init__(
        self,
        sample_col="sample",
        salmon_results_col="salmon_results",
        ...
        **kwargs,
        ...
        Args:
            sample_col (str): The name of the column that contains the sample name
                (default "sample").
            salmon_results_col (str): The name of the column that contains the salmon results
                directory path (default "salmon_results").

        """
        super().__init__(**kwargs)
        self._sample_col = sample_col
        self._salmon_results_col = salmon_results_col
    ...
    def validate_and_transform(self, row):
        ...
        self._validate_salmon_results(row)
        self._validate_condition(row)
        self._seen.add((row[self._sample_col], row[self._salmon_results_col]))
    ...
    def _validate_salmon_results(self, row):
        """Assert that the salmon results entry is non-empty and has the right format."""
        if len(row[self._salmon_results_col]) <= 0:
            raise AssertionError("At least the salmon results directory is required.")
        # TODO: Validate sample results
        # self._validate_salmon_results_format(row[self._salmon_results_col])
    ...
    # def _validate_salmon_results_format(self, filename):
    ...
    def validate_unique_samples(self):
        ...
        if len(self._seen) != len(self.modified):
            raise AssertionError("The pair of sample name and salmon result must be unique.")
        seen = Counter()
